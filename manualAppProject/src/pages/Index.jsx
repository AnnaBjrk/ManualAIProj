    ...
    return (
        <div className="font-['Neucha']">
            ...
            <section className="grid grid-cols-3 gap-4 my-3">
                <div className="flex flex-col border-1 rounded-sm border-amber-900 m-2 shadow-lg shadow-sky-500/50">
                    ...
                    <Link to="/query">
                        <button
                            className=" px-1 py-1 ml-4 mb-2 w-20  bg-sky-900 text-base rounded-sm text-amber-50">Fråga
                            AI</button>
                    </Link>
                </div>
                ...
                <div className="flex flex-col border-1 rounded-sm border-amber-900 m-2 shadow-lg shadow-blue-500/50">
                    ...
                    <Link to="/search">
                        <button
                            className=" px-1 py-1 ml-4 mb-2 w-30 bg-sky-900 text-base border rounded-sm  text-white">Sök
                            manual</button>
                    </Link>
                ...
                <div className="flex flex-col border-1 rounded-sm border-amber-900 m-2 shadow-lg shadow-blue-500/50">
                    ...
                    <Link to="/about">
                        <button
                            className=" px-1 py-1 ml-4 mb-2 w-30 bg-sky-900 text-base border rounded-sm text-white">Se
                            hela listan</button>
                    </Link>
                </div>
